    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('productionindex')}}"><img src="{{asset('images/logo.png')}}" alt="Logo"></a>
                <a class="navbar-brand hidden" href="{{url('productionindex')}}"><img src="{{asset('images/logo2.png')}}" alt="Logo"></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <a href="{{url('productionindex')}}"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>

                    <h3 class="menu-title">Production</h3><!-- /.menu-title -->
                    <li class="active">
                        <a href="{{url('productionorders')}}"> <i class="menu-icon fa fa-share-square-o"></i>Create Job Order </a>
                    </li>
